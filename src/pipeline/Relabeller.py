...
from src.Data import create_datas
...
from src.util import get_bio_base_name, numeric_string_sort, calc_dist, calc_mean_dist
...
class Relabeller():
    ...
    def relabel_annotation(self, data_files, tracks_relabel_dir, video_info):
        ...
        datas = []
        datas0 = create_datas(data_files)
        for data in datas0:
            data.calc_means()
