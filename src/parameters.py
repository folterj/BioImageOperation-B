...
LIVING_EARTH_PATH = 'D:/Video/Living_Earth/Spider Activity/cam1mp4/'
TRACKS_PATH = LIVING_EARTH_PATH + 'tracks_test/track*.csv'
TRACKS_RELABEL_PATH = LIVING_EARTH_PATH + 'tracks_relabel/'
TRACKS_PATH2 = TRACKS_RELABEL_PATH + 'track*.csv'
